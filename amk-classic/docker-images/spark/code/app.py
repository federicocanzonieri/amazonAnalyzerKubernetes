...
spark = get_spark_session(HOST_ELASTIC)
spark.sparkContext.setLogLevel("ERROR")

# hadoop_conf = spark._jsc.hadoopConfiguration()
# hadoop_conf.set("fs.s3n.impl", "org.apache.hadoop.fs.s3native.NativeS3FileSystem")
# hadoop_conf.set("fs.s3a.awsAccessKeyId", "AKIARLBECYJERSZ4MRBC")
# hadoop_conf.set("fs.s3a.awsSecretAccessKey", "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")
